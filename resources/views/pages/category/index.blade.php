    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body d-flex justify-content-between">
          <a href="{{ route('dashboard.category.create') }}" class="btn btn-primary"><i class="fas fa-plus"
              aria-hidden="true"></i>
            Tambah Data</a>
        </div>
        <div class="card-body">
            ...
            <table class="table table-striped" id="table-1">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td>
                    <a href="{{ route('dashboard.category.edit', $category->uuid) }}" class="btn btn-warning"><i
                        class="fa fa-pen" aria-hidden="true"></i></a>
                    <a href="{{ route('dashboard.category.show', $category->slug) }}" class="btn btn-info"><i
                        class="fa fa-eye" aria-hidden="true"></i></a>
                    <form action="{{ route('dashboard.category.destroy', $category->uuid) }}" method="POST"
                      class="d-inline">
                      @csrf
                      @method('delete')
